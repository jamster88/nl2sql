...
class TextTest {
    ...
    void the_three_entities_the_pipeline_escapes_are_the_three_undone() {
        ...
        // name into a symbol.
        assertEquals("Ben & Jerry's <Vanilla>", Text.plain("Ben &amp; Jerry's &lt;Vanilla&gt;"));
        assertEquals("&copy; 2026", Text.plain("&copy; 2026"));
    }
    ...
    void the_lead_is_the_prose_above_the_markdown_table() {
        ...
        assertEquals("Produce net sales were $719,279.97 in FY2025.",
                Text.lead("Produce net sales were $719,279.97 in FY2025.\n\n"
                        + "| department | net_sales |\n| --- | --- |\n"));
    }

    @Test
    void an_answer_that_is_only_prose_is_all_lead() {
        assertEquals("There is nothing to report.", Text.lead("  There is nothing to report.  "));
    }

    @Test
    void the_lead_is_unescaped_too() {
        assertEquals("Ben & Jerry's", Text.lead("Ben &amp; Jerry's\n\n| a |"));
    }
}
