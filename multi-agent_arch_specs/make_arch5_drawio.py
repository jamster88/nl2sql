#!/usr/bin/env python3
"""Emit Multi-Agent_NL2SQL_arch5.drawio next to this script.

    python multi-agent_arch_specs/make_arch5_drawio.py
...
OUT = str(Path(__file__).resolve().parent / "Multi-Agent_NL2SQL_arch5.drawio")
...
vertex("1", LX, 20, LW, 30,
       '<font style="font-size: 18px;"><b>Multi-Agent NL2SQL, v5</b></font>'
       '<font color="#666666"> &#8212; arch4 plus the answer contract and the Completeness Reviewer; supersedes arch1&#8211;4</font>',
...
page_h = out_y + 44 + 40
xml = (
    '<mxfile host="Electron" agent="arch5 generator" version="31.4.5">\n'
    '  <diagram name="Multi-Agent NL2SQL v5" id="arch5-v5">\n'
