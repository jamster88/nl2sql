...
Brings up the whole stack and opens the web interface in your browser.
      ...
      --no-browser   Start everything, but print the URL instead of opening it
...
Set BROWSER to choose what opens the page. ./setup.sh and ./launch.sh are the
same steps with the parts separated.
EOF
}
